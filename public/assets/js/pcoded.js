...
function layout_change(layout) {
  ...
  if (layout == 'dark') {
    ...
    if (document.querySelector('.navbar-brand .brand-logo')) {
      document.querySelector('.navbar-brand .brand-logo').setAttribute('src', '../../../../assets/images/logo-white.svg');
    }
    if (document.querySelector('.auth-main .brand-logo')) {
      document.querySelector('.auth-main .brand-logo').setAttribute('src', '../../../../assets/images/logo-white.svg');
    }
    ...
    dark_flag = false;
    if (document.querySelector('.pc-sidebar .m-header .logo-lg')) {
      document.querySelector('.pc-sidebar .m-header .logo-lg').setAttribute('src', '../../../../assets/images/pup-logo.png');
    }
    if (document.querySelector('.navbar-brand .logo-lg')) {
      document.querySelector('.navbar-brand .logo-lg').setAttribute('src', '../../../../assets/images/pup-logo.png');
    }
    if (document.querySelector('.navbar-brand .brand-logo')) {
      document.querySelector('.navbar-brand .brand-logo').setAttribute('src', '../../../../assets/images/pup-logo.png');
    }
    if (document.querySelector('.auth-main .brand-logo')) {
      document.querySelector('.auth-main .brand-logo').setAttribute('src', '../../../../assets/images/pup-logo.png');
    }
    if (document.querySelector('.footer-top .footer-logo')) {
      document.querySelector('.footer-top .footer-logo').setAttribute('src', '../../../../assets/images/pup-logo.png');
    }
    var control = document.querySelector('.theme-layout .btn.active');
    if (control) {
      document.querySelector('.theme-layout .btn.active').classList.remove('active');
