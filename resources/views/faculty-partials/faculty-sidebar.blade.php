 ...
 <nav class="pc-sidebar">
    <div class="navbar-wrapper">
        <div class="m-header">
            <a href="{{route ('faculty.faculty-records')}}" class="b-brand text-primary">
        ...
        <div class="navbar-content">
            <ul class="pc-navbar">
                ...
                <li class="pc-item">
                    <a href="{{route ('faculty.faculty-records')}}" class="pc-link">
                ...
                <li class="pc-item">
                    <a href="{{route ('faculty.faculty-trash')}}" class="pc-link">
                ...
                <li class="pc-item">
                    <a href="{{route ('faculty.faculty-history')}}" class="pc-link">
                ...
                <li class="pc-item">
                    <a href="{{route ('faculty.faculty-storage')}}" class="pc-link">
