...
<body>
    <div class="bg-container d-flex justify-content-center align-items-center vh-100">
        ...
        <div class="card-login text-center mx-auto p-4">
            ...
            <h3 class="text-role mb-3">Login as Faculty</h3>
            <div class="btn-container">
                <form action="{{ route('login.post') }}" method="POST">
                    ...
                    <p class="mt-2 mb-4">Don't have an account? <a href="{{ route('faculty-sign-up') }}" class="text-primary" style="text-decoration: underline;">Sign Up</a></p>
                </form>
            </div>
        </div>
    </div>
